...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 739.0, 52.0, 94.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 532.0, 23.0, 85.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 532.0, 52.0, 41.0, 22.0 ],
					"text" : "line 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 273.0, 23.0, 85.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 691.0, 351.0, 67.0, 22.0 ],
					"text" : "audio.send"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 532.0, 129.0, 29.5, 22.0 ],
					"text" : "+ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 532.0, 187.0, 39.0, 22.0 ],
					"text" : "$1 30"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 532.0, 223.0, 44.0, 22.0 ],
					"text" : "line~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 55.0, 223.0, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 129.0, 39.0, 22.0 ],
					"text" : "$1 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 273.0, 165.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 716.0, 91.0, 23.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 703.0, 2.0, 23.0, 20.0 ],
					"text" : "=>"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 457.0, 91.0, 23.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 444.0, 2.0, 23.0, 20.0 ],
					"text" : "=>"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 739.0, 90.0, 101.5, 22.0 ],
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 726.0, 1.0, 101.5, 22.0 ],
					"varname" : "umenu[1]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 532.0, 90.0, 100.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 519.0, 1.0, 100.0, 22.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 66.0, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 467.0, 1.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 634.0, 90.0, 79.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 621.0, 1.0, 79.5, 22.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 282.5, 204.5, 75.0, 204.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 64.5, 332.0, 700.5, 332.0 ],
					"order" : 0,
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 541.5, 268.0, 75.0, 268.0 ],
					"source" : [ "obj-30", 0 ]
				}
